...
Este indice es la lista completa con todos los meta-datos incluidos como una
hoja de datos (*data frame*) en R. 
...
Con `View(datos_compras)` podrás comprobar que los datos han sido bajado desde  y han sido convertidos a una hoja de datos (*data
frame*) en R.
...
o si encuentras errores (*bugs*) abre un incidente aquí en Github.
